    ...
    createQueryWrapper(moduleVersion) {
        ...
        return function wrapQuery(original) {
            return function wrapped_logging_method(query) {
                ...
                const transport = connectionSettings?.filename === ':memory:' ? 'inproc' : undefined;
